...
def mostrar_menu():
    ...
    print("")
    print(color_cyan + "1. Host Extractor ")
    print("2. Subdomain Extractor ")
    print("3. DNS Domain Extractor ")
    print("4. Check Host Status ")
    print("5. Payload Generator Pro ")
    print("6. View open ports ")
    print("7. Geolocation by IP")
    print("8. More information and credits")
    print("9. Change script language ")
    print("0. exit" + color_reset)
    print("")


def extraer_links():
    url = input("\033[1;32mEnter Host: ")
...
def guardar_archivo(urls):
    ...
    print("")
    print("The results have been saved to the file:", archivo)
    print("You can edit the text file to add other URLs and display statuses.")
    print("")
...
def extraer_subdominios():
    url = input("\033[32mEnter the Full URL: ")
    print("")
    ...
    print("\033[31mFOUND URLS:")
    print("")
    for u in urls:
        print("\033[32m", u)

    print("\033[31mINTERNAL SUBDOMAINS:")
    print("")
    for subdomain in internal_subdomains:
        print("\033[32m", subdomain)
        
    print("\033[31mEXTERNAL SUBDOMAINS:")
    print("")
...
def generar_payload():   
    time.sleep(1)
    os.system("python3 .payloaden.py")      
...
def verificar_estado_hosts():
    ...
    try:
        ...
        print("El archivo", archivo, "does not exist.")

    except Exception as e:
        print("Failed to check the status of hosts:", str(e))
        print("")


def ver_puertos_abiertos():
    host = input("\033[32mEnter the URL or IP: ")
    print("")
    print("Scanning open ports... This can take time!")
    print("")
    try:
        ...
        print("Error running nmap command:", str(e))
...
def ejecutar_opcion(opcion):
    if opcion == 1:
        ...
        ip = input("\033[1;32mEnter IP address: ")
        print("")
        ...
        print(f"IP adress: {ip_data['ip']}")
        print(f"Postal Code: {ip_data.get('postal', '')}")
        print(f"coordinates: {ip_data.get('loc', '')}")
        print(f"Internet Service Provider: {ip_data.get('isp', '')}")
        print(f"Time zone: {ip_data.get('timezone', '')}")
        print("")
        print(f"\033[1;36mGeolocation Link: https://www.google.com/maps/place/{ip_data.get('loc', '')}")
    elif opcion == 8:
        time.sleep(1)
        #Cambiar cat por type para windows
        print("\033[1;32m")
        os.system("cat READMEN.md") 
        ...
        print("\033[32m")
        print("Thanks for using Host-Extractor! Come back soon.")
        print("")
        return False
    else:
        print("Invalid option.")
...
while continuar:
    ...
    mostrar_menu()
    try:
        opcion = int(input("\033[31mEnter an option in number: "))
        continuar = ejecutar_opcion(opcion)
    except ValueError:
        print("Invalid option. Try again another way.")
        input("\nPress Enter to continue...")
